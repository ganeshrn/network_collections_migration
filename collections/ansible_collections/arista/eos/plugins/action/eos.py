...
from ansible_collections.network.common.plugins.action.network import ActionModule as ActionNetworkModule
from ansible_collections.network.common.plugins.module_utils.network.common.utils import load_provider
...
class ActionModule(ActionNetworkModule):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        if self._play_context.connection.split('.')[-1] in ('network_cli', 'httpapi'):
