...
from ansible_collections.network.common.plugins.module_utils.network.common.utils import is_masklen, validate_ip_address
from ansible_collections.network.common.plugins.module_utils.network.common.utils import remove_default_spec, validate_prefix
