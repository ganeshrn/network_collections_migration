...
class TestEosVlansModule(TestEosModule):
    ...
    def setUp(self):
        ...
        self.mock_get_config = patch('ansible_collections.network.common.plugins.module_utils.network.common.network.Config.get_config')
        self.get_config = self.mock_get_config.start()

        self.mock_load_config = patch('ansible_collections.network.common.plugins.module_utils.network.common.network.Config.load_config')
        self.load_config = self.mock_load_config.start()

        self.mock_get_resource_connection_config = patch('ansible_collections.network.common.plugins.module_utils.network.common.cfg.base.get_resource_connection')
        self.get_resource_connection_config = self.mock_get_resource_connection_config.start()

        self.mock_get_resource_connection_facts = patch('ansible_collections.network.common.plugins.module_utils.network.common.facts.facts.get_resource_connection')
