...
from ansible_collections.cisco.ios.plugins.module_utils.network.ios.providers.module import NetworkModule
from ansible_collections.cisco.ios.plugins.module_utils.network.ios.providers.cli.config.bgp.process import REDISTRIBUTE_PROTOCOLS
