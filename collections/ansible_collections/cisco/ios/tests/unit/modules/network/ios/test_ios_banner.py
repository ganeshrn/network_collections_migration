...
class TestIosBannerModule(TestIosModule):
    ...
    def setUp(self):
        ...
        self.mock_exec_command = patch('ansible_collections.cisco.ios.plugins.modules.ios_banner.exec_command')
        self.exec_command = self.mock_exec_command.start()

        self.mock_load_config = patch('ansible_collections.cisco.ios.plugins.modules.ios_banner.load_config')
