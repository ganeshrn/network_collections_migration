...
from ansible_collections.network.common.tests.unit.compat.mock import patch, MagicMock, PropertyMock
...
if PY3:
    with patch('builtins.__import__', side_effect=import_mock):
        from ansible_collections.network.common.plugins.connection import netconf
...
class TestNetconfConnectionClass(unittest.TestCase):
    ...
    @patch('ansible_collections.network.common.plugins.connection.netconf.netconf_loader')
