...
from ansible_collections.network.common.tests.unit.compat import unittest
from ansible_collections.network.common.tests.unit.compat.mock import patch, MagicMock
...
class TestConnectionClass(unittest.TestCase):
    ...
    @patch('ansible_collections.network.common.plugins.connection.network_cli.terminal_loader')
    ...
    @patch('ansible_collections.network.common.plugins.connection.network_cli.Connection._get_terminal_std_re')
    @patch('ansible_collections.network.common.plugins.connection.network_cli.Connection._connect')
