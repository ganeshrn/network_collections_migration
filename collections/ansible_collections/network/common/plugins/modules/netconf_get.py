...
from ansible_collections.network.common.plugins.module_utils.network.netconf.netconf import get_capabilities, get_config, get
from ansible_collections.network.common.plugins.module_utils.network.common.netconf import remove_namespaces
